...
const Navbar = () => {
    return (
        <nav className=" w-full  p-6 mx-auto bg-zinc-800 flex  justify-between border-b-[2px] border-zinc-100">
            ...
            <span
                ...
                className="w-2 h-2 bg-green-500 rounded-full shadow-green-400"
            ></span>
